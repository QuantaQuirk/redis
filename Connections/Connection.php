...
namespace QuantaQuirk\Redis\Connections;

use Closure;
use QuantaQuirk\Contracts\Events\Dispatcher;
use QuantaQuirk\Redis\Events\CommandExecuted;
use QuantaQuirk\Redis\Limiters\ConcurrencyLimiterBuilder;
use QuantaQuirk\Redis\Limiters\DurationLimiterBuilder;
...
abstract class Connection
{
     ...
     *
     * @param  string  $name
     * @return \QuantaQuirk\Redis\Limiters\ConcurrencyLimiterBuilder
     */
     ...
     *
     * @param  string  $name
     * @return \QuantaQuirk\Redis\Limiters\DurationLimiterBuilder
     */
