...
namespace QuantaQuirk\Redis;

use Closure;
use QuantaQuirk\Contracts\Redis\Factory;
use QuantaQuirk\Redis\Connections\Connection;
use QuantaQuirk\Redis\Connectors\PhpRedisConnector;
use QuantaQuirk\Redis\Connectors\PredisConnector;
use QuantaQuirk\Support\Arr;
use QuantaQuirk\Support\ConfigurationUrlParser;
use InvalidArgumentException;

/**
 * @mixin \QuantaQuirk\Redis\Connections\Connection
 */
class RedisManager implements Factory
{
     ...
     *
     * @param  \QuantaQuirk\Redis\Connections\Connection  $connection
     * @param  string  $name
     * @return \QuantaQuirk\Redis\Connections\Connection
     */
     ...
     *
     * @return \QuantaQuirk\Contracts\Redis\Connector|null
     */
