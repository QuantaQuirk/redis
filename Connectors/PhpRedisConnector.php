...
use QuantaQuirk\Redis\Connections\PhpRedisClusterConnection;
use QuantaQuirk\Redis\Connections\PhpRedisConnection;
use QuantaQuirk\Support\Arr;
use QuantaQuirk\Support\Facades\Redis as RedisFacade;
...
class PhpRedisConnector implements Connector
{
     ...
     * @param  array  $config
     * @param  array  $options
     * @return \QuantaQuirk\Redis\Connections\PhpRedisConnection
     */
     ...
     * @param  array  $options
     * @return \QuantaQuirk\Redis\Connections\PhpRedisClusterConnection
     */
